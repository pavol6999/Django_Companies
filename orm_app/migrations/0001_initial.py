# Generated by Django 3.1 on 2021-04-28 13:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('corporate_body_name', models.CharField(blank=True, max_length=1000, null=True)),
                ('cin', models.BigIntegerField(blank=True, null=True)),
                ('street', models.CharField(blank=True, max_length=1000, null=True)),
                ('building_number', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('releaser_position', models.CharField(blank=True, max_length=1000, null=True)),
                ('sent_by', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sid', models.CharField(blank=True, max_length=1000, null=True)),
                ...
                ('br_insertion', models.CharField(blank=True, max_length=1000, null=True)),
                ('br_court_code', models.CharField(blank=True, max_length=1000, null=True)),
                ('br_court_name', models.CharField(blank=True, max_length=1000, null=True)),
                ('br_section', models.CharField(blank=True, max_length=1000, null=True)),
                ('other_registrar_name', models.CharField(blank=True, max_length=1000, null=True)),
                ('other_registration_number', models.CharField(blank=True, max_length=1000, null=True)),
                ...
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
                ('debtee_legal_form_code', models.CharField(blank=True, max_length=1000, null=True)),
                ('debtee_legal_form_name', models.CharField(blank=True, max_length=1000, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('prefixes', models.CharField(blank=True, max_length=1000, null=True)),
                ('postfixes', models.CharField(blank=True, max_length=1000, null=True)),
                ('given_name', models.CharField(blank=True, max_length=1000, null=True)),
                ('family_name', models.CharField(blank=True, max_length=1000, null=True)),
                ('street', models.CharField(blank=True, max_length=1000, null=True)),
                ('building_number', models.CharField(blank=True, max_length=1000, null=True)),
                ('postal_code', models.CharField(blank=True, max_length=1000, null=True)),
                ('city', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_ov_released_number', models.CharField(blank=True, max_length=1000, null=True)),
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
            ],
            options={
